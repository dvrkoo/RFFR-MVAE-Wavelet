...
class DefaultConfigs(object):
    ...
    # DFD specific real test path
    dfd_real_test_label_path = (
    ...
    use_mixed_forgeries = True  # Enable dynamic multi-forgery mixing at training time
    forgery_mix_types = [
        "f2f",
        "df",
...
# Add DFD and CelebDF fake test paths
config.test_label_path.append("Faceforensics/excludes_hq/dfd_test_label_fixed.json")
config.test_label_path.append(
    "Faceforensics/excludes_hq/celebdf_fake_test_label_fixed.json"
)
# Add DFDC test paths
config.test_label_path.append("DFDC/all_test_label.json")
config.dfdc_real_test_label_path = "DFDC/real_test_label.json"
